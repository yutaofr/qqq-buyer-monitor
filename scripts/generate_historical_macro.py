...
def _build_dev_fixture_frame() -> pd.DataFrame:
    ...
    regimes = [
        ("2000-03-10", "2003-12-31", 1000.0, 32.0, 0.012, 0.005, -0.1, 180.0, 1),
        ("2008-09-01", "2009-06-01", 2000.0, 15.0, 0.060, 0.010, 0.5, 120.0, 1),
        ("2020-02-15", "2020-05-01", 800.0, 18.0, 0.052, 0.008, 0.2, 90.0, 1),
        ("2021-06-01", "2021-11-01", 200.0, 29.0, 0.018, -0.010, -0.2, 270.0, 0),
        ("2022-01-01", "2022-12-31", 500.0, 20.0, 0.040, 0.020, 0.1, 150.0, 0),
    ]
