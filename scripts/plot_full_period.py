...
def plot_full_analysis():
    ...
    if tractor_prob_col not in df.columns:
        if os.path.exists(
            "/Users/weizhang/w/backtests/artifacts/v14_panorama/baseline_oos_trace.csv"
        ):
    ...
    print(
        "Saved to /Users/weizhang/w/backtests/artifacts/analysis/full_8yr_trend_plot_detailed.png"
    )
