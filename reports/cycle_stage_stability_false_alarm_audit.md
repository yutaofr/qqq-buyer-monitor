# Cycle Stage Stability And False-Alarm Audit

## Decision
`STAGE_STABILITY_IS_PRACTICALLY_USABLE`
...
```json
{
  "decision": "STAGE_STABILITY_IS_PRACTICALLY_USABLE",
  "event_family_rows": [
    {
  ...
  "required_audits": {
    ...
    "one_day_reversals": 112,
    "overuse_of_FAST_CASCADE_BOUNDARY": 0.03433671154137044,
    "stage_flapping_frequency": 0.07972768532526475,
    "stage_persistence_statistics": {
      "EXPANSION": {
        "max_days": 145,
        "median_days": 5.0
      },
