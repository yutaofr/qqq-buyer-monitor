    ...
    def generate_synthetic_baseline(self, start_year: int = 2010):
        ...
        for d in dates:
            ...
            if year == 2020:
                ...
                cycle_phase = year % 4
                if cycle_phase == 0: regime = "RECOVERY"
                elif cycle_phase == 1: regime = "MID_CYCLE"
                elif cycle_phase == 2: regime = "LATE_CYCLE"
                else: regime = "BUST"
            else:
                regime = "MID_CYCLE"
            ...
            data.append({
                ...
                "forward_pe": 100.0 / (erp + yield_10y + 0.05) if erp + yield_10y + 0.05 > 0 else 20.0,
