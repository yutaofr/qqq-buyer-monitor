...
def _to_json_dict(result: SignalResult) -> dict:
    ...
    return {
        ...
        "target_exposure_ceiling": _float(result.target_exposure_ceiling),
        "target_cash_floor": _float(result.target_cash_floor),
        "qld_share_ceiling": _float(result.qld_share_ceiling),
