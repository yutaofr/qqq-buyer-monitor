...
def test_sidecar_train_audit_fallback():
    ...
    assert model.constrained_flag is True, "Model should have fallen back to constrained optimization"
...
def test_sidecar_train_no_fallback_on_valid_data():
    ...
    assert hasattr(model, "constrained_flag")
    assert model.constrained_flag is False, "Model should NOT have fallen back to constrained optimization"
