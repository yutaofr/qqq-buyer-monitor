    ...
    macro = pd.DataFrame(
        {
            ...
            "source_nfci": ["fred:NFCI"] * len(dates),
    ...
    macro = pd.DataFrame(
        {
            ...
            "source_forward_pe": ["synthetic_fixture", "synthetic_fixture"],
            "source_erp": ["synthetic_fixture", "synthetic_fixture"],
            "source_real_yield": ["synthetic_fixture", "synthetic_fixture"],
            "source_nfci": ["synthetic_fixture", "synthetic_fixture"],
